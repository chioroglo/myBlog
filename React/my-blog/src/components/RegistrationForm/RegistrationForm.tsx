...
import { FirstnameLastnameConstraints, palette, PasswordValidationConstraints, UserValidationConstraints } from '../../shared/assets';
            ...
            <form style={{display:"inline-block"}} onSubmit={formik.handleSubmit}>
                <Paper style={paperStyle} elevation={12}>
                    ...
                    <FormControl style={textFieldStyle}>
                        ...
                        <FormHelperText>
                            Contains from {UserValidationConstraints.MinLength} to {UserValidationConstraints.MaxLength} characters<br/>
                            {formik.touched.username && formik.errors.username && (<span style={errorTextStyle}>{formik.errors.username}</span>)}
                        </FormHelperText>
                    </FormControl>
                    ...
                    <FormControl style={textFieldStyle}>
                        ...
                        <FormHelperText>
                            Optional
                            {formik.touched.firstName && formik.errors.firstName && (<span style={errorTextStyle}>{formik.errors.firstName}</span>)}
                        </FormHelperText>
                    </FormControl>
                    ...
                    <FormControl style={textFieldStyle}>
                        ...
                        <FormHelperText>
                            Optional
                            {formik.touched.lastName && formik.errors.lastName && (<span style={errorTextStyle}>{formik.errors.lastName}</span>)}
                        </FormHelperText>
                    </FormControl>
                    ...
                    <FormControl style={textFieldStyle}>
                        ...
                        <FormHelperText>
                            Contains from {PasswordValidationConstraints.MinLength} to {PasswordValidationConstraints.MaxLength} characters<br/>
                            {formik.touched.password && formik.errors.password && (<span style={errorTextStyle}>{formik.errors.password}</span>)}
                        </FormHelperText>
                    </FormControl>

                    <FormControl style={textFieldStyle}>
                        <InputLabel htmlFor="confirmPassword">Repeat password</InputLabel>
                        <Input type="password" onChange={formik.handleChange} value={formik.values.confirmPassword} name="confirmPassword"/>
                        <FormHelperText>
                            {formik.touched.confirmPassword && formik.errors.confirmPassword && (<span style={errorTextStyle}>{formik.errors.confirmPassword}</span>)}
                        </FormHelperText>
                    </FormControl>
                    ...
                    ?
                        <CustomSnackbar closeHandler={closeSnackbar} isOpen={isSnackbarOpened} alertMessage="Registration successful" alertType="success"/>
                    :
                        <CustomSnackbar closeHandler={closeSnackbar} isOpen={isSnackbarOpened} alertMessage={registrationFailureMessage} alertType="error"/>
                }
            </form>
        }
        </> 
