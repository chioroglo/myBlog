...
const LogoutCustomModal = ({logoutHandler,modalOpen,setModalOpen}:{logoutHandler: () => void,modalOpen: boolean, setModalOpen: React.Dispatch<React.SetStateAction<boolean>>}) => {
    return (
