...
const CustomSnackbar = ({isOpen = false,alertMessage = "Snackbar",alertType = "info", closeHandler}: SnackbarProps) => {
    ...
    return (
        ...
        <Snackbar transitionDuration={1500} onClose={onClose} open={isOpen} autoHideDuration={1500} message={alertMessage}>
