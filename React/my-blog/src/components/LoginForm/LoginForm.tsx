...
import { AuthenticateRequest } from '../../shared/api/types';
        ...
        :
            <form style={{display:"inline-block"}} onSubmit={formik.handleSubmit}>
                ...
                <Paper style={paperStyle} elevation={12}>
                    ...
                    <FormControlLabel name="rememberMe" style={checkboxStyle} onChange={formik.handleChange} label="Remember me?" control={<Checkbox/>}/>
                    <Button variant="outlined" style={buttonStyle} type="submit">Log in</Button> 
                    
                    <Link style={{textAlign:"center",fontStyle:"italic",textDecoration:"bold",color:palette.JET}} to="/register">Do not have an account? Click here</Link>
                </Paper>
                {
                    authorizationSuccessful
                    ?
                        <CustomSnackbar closeHandler={closeSnackbar} isOpen={isSnackbarOpened} alertMessage="Authorization successful" alertType="success"/>
                    :
                        <CustomSnackbar closeHandler={closeSnackbar} isOpen={isSnackbarOpened} alertMessage={authorizationFailureMessage} alertType="error"/>
                }
            </form>
        }
        </>
