        ...
        <Paper style={{width:width,margin:"0 auto",minHeight:"50px",padding:"20px"}}>
            ...
            <Box sx={{minWidth:"120px",display:"flex",alignContent:"flex-start"}}>
                ...
                <Box style={{minWidth:"20%"}}>
                    ...
                    <Select sx={{minWidth:"150px"}} value={filterDropdown} onChange={(e) => setFilterDropdown(e.target.value)}>
                ...
                <Box>
                    <Button disabled={filterDropdown.length === 0 || filterValue.length === 0} variant="outlined" onClick={handleAddFilter}>Add filter</Button>
                </Box>
            </Box>
            <>
